...
9) App8_TwitterAnalyzeBot: Generates a sentiment plot when it's requested by another user.
	- Status: not turned on.
	- How to use: Example of a request to do Sentiment analysis on CNN "@LenaCorredor Analyze: @CNN"  
				  Result will be a Sentiment Analysis of CNN tweeted to the requested user.
				  Script will also output a log file.
