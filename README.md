...
1) Presentation: Data engineering experiment - comparing Pandas to Python data structure for an ETL process
    https://docs.google.com/presentation/d/1_YzgOiKi_mDTA2ZA-337RQc9RMSzSYbIX39nPaqlXSw/edit?usp=sharing

2) App8_TwitterAnalyzeBot: Generates a sentiment plot with the request of another Twitter user.
...
3) App7_FinancialGraph: Candle stick stock price graph deployed on Heroku.
...
4) App6_webscrapper: An app that scraps century21 property information for Rock Springs, WY
...
5) App5_BookStore: A bookstore standalone application that stores book information.
...
6) App3_website_blocker: A website blocker that blocks users from accessing certain website between 8am and 4pm.
	- Tools in the app: time, datetime, host file

7) App2_webmap: A map showing the valcano locations and population of each country.
	- How to run: 
...
8) app_physiology_card_game: This is a beta version. A buzzfeed game that helps the player learn human physiology.
...
9) App_weather_api: Connects to a weather website api and checks the weather to see if an umbrella is needed today.
...
10) App1_Dictionary: a python command line app that outputs the definition of a word entered.
